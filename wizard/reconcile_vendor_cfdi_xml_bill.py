    ...
    def action_reconcile(self):
        ...
        for attachment in attachments:
            ...
            vals = {
                ...
                'forma_pago_id': self.env['payment.type'].sudo().search([('code','=',data.get('Comprobante',{}).get('@FormaPago',''))]).id,
                ...
                'uso_cfdi_id': self.env['uso.cfdi'].sudo().search([('code','=',uso_data.get('@UsoCFDI'))]).id,
                }
            if self.typo_de_combante in ['P','SP']:
